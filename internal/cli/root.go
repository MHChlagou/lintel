...
func NewRoot() *cobra.Command {
	root := &cobra.Command{
		Use:   "lintel",
		Short: "Lintel - the shield your commits pass through",
		Long: `Lintel is a shift-left security orchestrator that runs as a Git hook.
...
osv-scanner, biome, ruff, golangci-lint, …) driven by one declarative spec.`,
	...
	root.PersistentFlags().StringVar(&flags.configPath, "config", "", "path to lintel.yaml (default: .lintel/lintel.yaml)")
