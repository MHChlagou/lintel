...
=== "macOS / Linux"
    ...
    curl -fsSL https://raw.githubusercontent.com/MHChlagou/lintel/main/scripts/install.sh | sh -s -- --version v0.2.3
...
=== "Go toolchain"
    ...
    ```bash
    go install github.com/MHChlagou/lintel/cmd/lintel@latest
    # Or pin: go install github.com/MHChlagou/lintel/cmd/lintel@v0.2.3
    ```
