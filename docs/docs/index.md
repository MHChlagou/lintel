...
[View on GitHub :fontawesome-brands-github:](https://github.com/MHChlagou/lintel){ .md-button }
...
-   :material-file-document-outline:{ .lg .middle } **Declarative config**
    ...
    One `lintel.yaml` describes stacks, scanners, gates, and ignores.
...
-   :material-source-branch:{ .lg .middle } **Git-hook native**
    ...
    `lintel install` manages `pre-commit` and `pre-push` hooks without
...
- Learn about the [supply-chain model](supply-chain.md) - the bit that makes Lintel different.
